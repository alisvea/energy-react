...
// =============================================================================
// TEMPLATE NAME: specialCalc19test - No Container | No Header, Footer
// -----------------------------------------------------------------------------
// =============================================================================
...
<style type="text/css">
	...
	span#pwpPriceText {font-size: inherit; font-weight: 600;}
			...
			<div id="formRightContent">
				...
				<div>
					...
					<div id="pwpPriceWrapper" onclick = "togglePopup('priceSolarPopup', 'block', 'maskpriceSolarPopup')">
						<h1 id="pwpPrice">Spotpris + 30 <span id="pwpPriceText">öre</span></h1>
					</div>
			...
			<div id="ppkParts">
				<table>
					<tr>
						...
						<td>
							<h2>
								<?php echo round($spotPrice, 2);?> öre <span style="color: rgb(115, 164, 33);">*</span></h2>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<h2>60 öre <span style="color: rgb(115, 164, 33);">**</span></h2>
						</td>
					</tr>
				</table>
			</div>
				...
				<table>
					<tr>
						<td colspan=2>
							...
							<p style="font-size: 16px; text-align: center;color: rgb(115, 164, 33);">*SVEA Energy pris, år 2-3: 5 öre</p>
