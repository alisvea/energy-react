...
function updatePrice(x) {
    ...
    let pricePerProdHour = (40.819083333333 / 100) + 0.9;

    if (document.getElementById("stepInput").value === "productionHigh") {
        pricePerProdHour = (40.819083333333 / 100) + 0.65;
    } else if (document.getElementById("stepInput").value === "productionLow") {
        pricePerProdHour = (40.819083333333 / 100) + 0.63;
    }

    // Consumption price per kWh
    let pricePerKwh = 60.898854166666;
...
var spPrice = 40.819083333333;

function calculatePrice() {
    let spotPrice = 40.819083333333;
    let pricePerKwh = 60.898854166666;
    let vatJS = 12.179770833333;
    ...
    price = Math.round(price - (monthlyProduction * (0.65 * (40.819083333333 + 5.95 + 6.75) / 100 + (0.35 * (40.819083333333 + 5 + 60) / 100))));
    updatePrice(price);
}
...
h._hjSettings={hjid:1219455,hjsv:6};
